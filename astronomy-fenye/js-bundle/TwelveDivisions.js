window.TwelveDivisions = (function() {
  class TwelveDivisions {
    ...
    createDivisions() {
      StarData.twelveDivisions.forEach(division => {
    ...
    addDivisionLabel(division, ra, dec) {
      const pos = StarData.raDecToVector3(ra, dec, this.sceneManager.sphereRadius + 8);
    ...
    static getTwelveDivisions() {
      return StarData.twelveDivisions;
    }

    static getDivisionByName(name) {
      return StarData.twelveDivisions.find(d => d.name === name);
    }
  }
